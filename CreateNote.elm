                ...
                [ div [ class "card yellow ", style [ ( "padding", "10px" ) ] ]
                    ...
                    , div [ class "row" ]
                        [ div [ class "col s6 offset-s3" ]
                            [ div [ class "input-field" ]
                                [ input [ id "title", type_ "text", onInput NoteTitle, Attr.value model.noteTitle ] []
                                , label [ for "title" ] [ text "Note Title" ]
                                ]
                            ]
                        ]
                    , div [ class "row" ]
                        [ div [ class "col s6 offset-s3" ]
                            [ div [ class "input-field" ]
                                [ input [ id "cnt", type_ "text", onInput NoteDescription, Attr.value model.noteDescription ] []
                    ...
                    , div [ class "row" ]
                        [ div [ class "col s2  offset-s4" ]
                            [ div [ class "btn waves-effect waves-light", onClick (SubmitNote) ]
                                [ text "Submit" ]
                            ]
                        , div [ class "col s3 " ]
                            [ div
